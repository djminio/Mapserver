...
typedef enum _eWARFIELD_PORT
{
	...
	WP_MOUNTAIN_WARFIELD = WARFIELD_PORT1,	// 산중 전쟁터
	WP_PLAIN_WARFIELD = WARFIELD_PORT2,	// 평원 전쟁터
	WP_ISLAND_WARFIELD = WARFIELD_PORT3,	// 섬 전쟁터
	WP_SNOWY_WARFIELD = BASE_NEW_WARFIELD_PORT,	// 설원 전쟁터
	WP_HADES_WARFIELD = 12009,	// Hades Warfield Port
	WP_MAX_WARFIELD_PORT = 12010,	// 최대 전쟁터 포트 번호
#else
	WP_BASE_PORT = BASE_WARFIELD_PORT,
